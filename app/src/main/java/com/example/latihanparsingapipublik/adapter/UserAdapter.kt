...
class UserAdapter(private val users: MutableList<DataItem>)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.tvEmail.text = user.email.toString()
    ...
    class ListViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        var tvUserName: TextView = itemView.findViewById(R.id.textView)
        var tvEmail: TextView = itemView.findViewById(R.id.textView2)
